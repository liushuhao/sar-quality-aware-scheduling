...
\begin{figure}[H]
    ...
    \caption{Ablation results across four objective-function variants (A--D) and four scenario classes: grouped bars show degradation percentages relative to baseline A for each variant; negative values indicate variant outperforms baseline}
    \label{fig:fig6}
\end{figure}
...
(ii) without exact methods (documented intractable in the preceding section). We
