...
print(f"  [DEPRECATED] r_emp = 0.93 -- 0.98 was an unreproducible hardcoded constant, removed per RDR-002 (see REVIEW_INDEX.md). All reproducible schedule-level calibers are negative (~-0.69 to -0.17 for full physics).")
...
print(f"  [DEPRECATED] the claim 'empirical r = +0.93 to +0.98 (PSI axis dominates)' was unreproducible (RDR-002). Reproducible schedule-level r is negative; theta-axis conflict is narrowed by low-squint convergence, not reversed.")
